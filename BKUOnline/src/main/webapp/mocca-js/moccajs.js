...
define('moccajs', function(require) {
    ...
    /**
     * Attempts to run a signature process with given parameter. Sends soap requests to backend and interacts with the global object WorkflowExe and log.
     ...
     * @param {boolean} isMockSTAL flag for replacing the Stal interacting with the WorkflowExe.
    ...
    /**
     * Adds logoutput before calling the appropiate backend method.
     */
